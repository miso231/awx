...
class CredentialInputSource(PrimordialModel):
    ...
    def clean(self):
        super(CredentialInputSource, self)
        ...
        if self.input_field_name not in self.target_credential.inputs:
            raise ValidationError(_('Input field must be present on target credential.'))
